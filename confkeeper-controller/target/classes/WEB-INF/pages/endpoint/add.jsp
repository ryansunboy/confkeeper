			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form class="form-horizontal" action="${pageContext.request.contextPath}/endpoint/add" method="post">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">应用名称 </label>
							  <div class="controls">
								<select data-rel="chosen" class="chzn-done" id="appId" name="appId">
								<c:forEach items="${apps}" var="obj">
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							  	<input class="input-xlarge focused" id="trunk" type="text" name="trunk">
							  </div>
							</div>
							<div class="control-group">
