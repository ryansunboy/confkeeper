		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">添加版本</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 添加新版本</h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" action="${pageContext.request.contextPath}/endpoint/${e.id}" method="post">
						  <fieldset>
							...
							<div class="control-group">
							  ...
							  <div class="controls">
							  	<input class="input-xlarge focused" id="trunk" type="text" name="trunk" value="${e.trunk}">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">状态 </label>
							  <div class="controls">
								<select data-rel="chosen" class="chzn-done" id="state" name="state">
									<c:choose>
										...
										<c:otherwise>
											...
											<option value="0" selected="selected">待命</option>
										</c:otherwise>
									</c:choose>
								</select>
							  </div>
