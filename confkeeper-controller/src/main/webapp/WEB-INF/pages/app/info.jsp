		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">修改列表</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 修改应用</h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" action="${pageContext.request.contextPath}/app/${e.id}" method="post">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">应用名称 </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="appName" name="appName" value="${e.appName}">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">应用备注 </label>
							  <div class="controls">
								<textarea class="textarea" id="appNote" name="appNote" rows="3" style="width: 402px; height: 197px;">${e.appNote}</textarea>
							  </div>
							</div>
