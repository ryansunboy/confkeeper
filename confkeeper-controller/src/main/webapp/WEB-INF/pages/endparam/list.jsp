...
<link href="${pageContext.request.contextPath}/css/bootstrap-responsive.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/css/charisma-app.css"
	rel="stylesheet">
<link href="${pageContext.request.contextPath}/css/jquery-ui-1.8.21.custom.css"
	rel="stylesheet">
<link href='${pageContext.request.contextPath}/css/fullcalendar.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/fullcalendar.print.css'
	rel='stylesheet' media='print'>
<link href='${pageContext.request.contextPath}/css/chosen.css' rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/uniform.default.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/colorbox.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/jquery.cleditor.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/jquery.noty.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/noty_theme_default.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/elfinder.min.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/elfinder.theme.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/jquery.iphone.toggle.css'
	rel='stylesheet'>
<link href='${pageContext.request.contextPath}/css/opa-icons.css'
	rel='stylesheet'>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-bar"></span>
				</a> <a class="brand" href="javascript:void(0);"><span>Confkeeper
						Manager</span></a>

				<!-- theme selector starts -->
				<div class="btn-group pull-right theme-container">
					<a class="btn dropdown-toggle" data-toggle="dropdown"
						href="javascript:void(0);"> <i class="icon-tint"></i><span
						class="hidden-phone"> 修改主题</span> <span class="caret"></span>
					</a>
					<ul class="dropdown-menu" id="themes">
						...
						<li><a data-value="cyborg" href="javascript:void(0);"><i
								class="icon-blank"></i> Cyborg</a></li>
						<li><a data-value="redy" href="javascript:void(0);"><i
								class="icon-blank"></i> Redy</a></li>
						<li><a data-value="journal" href="javascript:void(0);"><i
								class="icon-blank"></i> Journal</a></li>
						<li><a data-value="simplex" href="javascript:void(0);"><i
								class="icon-blank"></i> Simplex</a></li>
						<li><a data-value="slate" href="javascript:void(0);"><i
								class="icon-blank"></i> Slate</a></li>
						<li><a data-value="spacelab" href="javascript:void(0);"><i
				...
				<div class="btn-group pull-right">
					<a class="btn dropdown-toggle" data-toggle="dropdown"
						href="javascript:void(0);"> <i class="icon-user"></i><span
						class="hidden-phone"> ${auth_user.userName}</span> <span class="caret"></span>
					</a>
	...
	<div class="container-fluid">
		<div class="row-fluid">
				...
				<div class="well nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a class="ajax-link"
							href="${pageContext.request.contextPath}/app"><i
								class="icon-th-large"></i><span class="hidden-tablet"> 应用</span></a></li>
						<li><a class="ajax-link"
							href="${pageContext.request.contextPath}/endpoint"><i
								class="icon-leaf"></i><span class="hidden-tablet"> 版本</span></a></li>
						<li><a class="ajax-link"
							href="${pageContext.request.contextPath}/endparam"><i
								class="icon-list"></i><span class="hidden-tablet"> 参数</span></a></li>

						<li class="nav-header hidden-tablet">权限管理</li>
						<li><a class="ajax-link" href="index.html"><i class="icon-globe"></i><span
								class="hidden-tablet"> 模块</span></a></li>
						<li><a class="ajax-link" href="index.html"><i
								class="icon-eye-open"></i><span class="hidden-tablet"> 权限</span></a></li>
						<li><a class="ajax-link" href="index.html"><i class="icon-filter"></i><span
								class="hidden-tablet"> 角色</span></a></li>

						<li class="nav-header hidden-tablet">系统管理</li>
						<li><a class="ajax-link" href="index.html"><i class="icon-cog"></i><span
								class="hidden-tablet"> 控制台</span></a></li>
						<li><a class="ajax-link" href="index.html"><i
								class="icon-list-alt"></i><span class="hidden-tablet"> 日志</span></a></li>
						<li><a class="ajax-link" href="index.html"><i
								class="icon-asterisk"></i><span class="hidden-tablet"> 修改密码</span></a></li>
					</ul>
				</div>
				<!--/.well -->
			</div>
			...
			<div id="content" class="span10">
				...
				<div>
					<ul class="breadcrumb">
						<li><a href="javascript:void(0);">首页</a> <span class="divider">/</span>
						</li>
										...
										<tr>
											...
											<c:choose>
												<c:when test="${obj.type==0}">
													<span class="label label-success">静态值</span>
												</c:when>
												<c:otherwise>
													<span class="label label-important">动态值</span>
												</c:otherwise>
											</c:choose>
											</td>
											<td>${obj.key}=${obj.value}</td>
											<td class="center"><a class="btn btn-danger"
												href="${pageContext.request.contextPath}/endparam/remove/${obj.id}">
		...
		<footer>
			<p class="pull-left">
				&copy; <a href="http://www.qianwang365.com" target="_blank">www.qianwang365.com</a>
				2014
			</p>
			<p class="pull-right">
				Powered by: <a href="mailto:40055595@qq.com">Yate</a>
			</p>
		</footer>
