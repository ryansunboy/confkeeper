		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="${pageContext.request.contextPath}/app">版本列表</a> <span class="divider">/</span> 
					</li>
					<li>
						<a href="javascript:void(0);">配置参数</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-edit"></i> 配置清单</h2>
					</div>
					<div class="box-content">
						<form class="form-horizontal" action="${pageContext.request.contextPath}/endparam/add" method="post">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">应用名称 </label>
							  <div class="controls">
							  	<input type="hidden" id="ep_id" name="ep_id" value="${e.id}">
								<input class="input-xlarge disabled" type="text" disabled="" value="${e.app.appName}">
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="date01">版本 </label>
							  <div class="controls">
							  	<input class="input-xlarge disabled" disabled="" id="trunk" type="text" name="trunk" value="${e.trunk}">
							  </div>
							</div>
							<div class="control-group">
							  ...
							  <div class="controls">
							  	<c:choose>
									<c:when test="${e.state==1}">
										<input class="input-xlarge disabled" disabled="" id="trunk" type="text" name="trunk" value="激活">
									</c:when>
									<c:otherwise>
										<input class="input-xlarge disabled" disabled="" id="trunk" type="text" name="trunk" value="待命">
									</c:otherwise>
								</c:choose>
							  </div>
							</div>
							...
							<div class="control-group">
							  	<label class="control-label" for="typeahead">参数清单 </label>
							  	<div class="controls">
							  		<textarea class="textarea" id="params" name="params" rows="3" style="width: 804px; height: 197px;">${pv}</textarea>
							  	</div>
							 </div>
							
							<div class="form-actions">
								<button type="submit" class="btn btn-primary">更新参数</button>
