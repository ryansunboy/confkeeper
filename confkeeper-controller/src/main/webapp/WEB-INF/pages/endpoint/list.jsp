		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="javascript:void(0);">版本列表</a>
					</li>
				</ul>
			</div>
			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-leaf"></i> 版本列表</h2>
						<div class="box-icon">
								<a href="${pageContext.request.contextPath}/endpoint/add" class="btn btn-setting btn-round"><i class="icon-plus"></i></a>
							...
							<tr>
								...
								<td>
									<c:choose>
										...
										<c:otherwise>
											<span class="label label-important">待命</span>
										</c:otherwise>
									</c:choose>
									
								</td>
								<td>
									<a class="btn btn-success" href="${pageContext.request.contextPath}/endpoint/params/${obj.id}">
										<i class="icon-zoom-in icon-white"></i>  
										参数详细                                            
									</a>
								</td>
								<td class="center">
									<a class="btn btn-info" href="${pageContext.request.contextPath}/endpoint/${obj.id}">
										<i class="icon-edit icon-white"></i>  
										修改                                            
									</a>
									<a class="btn btn-danger" href="${pageContext.request.contextPath}/endpoint/remove/${obj.id}">
